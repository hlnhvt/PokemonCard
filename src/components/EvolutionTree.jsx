...
export function EvolutionTree({ pokemon, scanCount = 0, canEvolve = true, onEvolve, onExplore }) {
      ...
      {canEvolve && current && nextForms.length > 0 && (
        scansLeft === 0 ? (
          ...
          <div>
            ...
            <div className="mt-1.5 h-3 rounded-full bg-slate-800 overflow-hidden" role="progressbar" aria-valuemin={0} aria-valuemax={SCANS_TO_EVOLVE} aria-valuenow={Math.min(scanCount, SCANS_TO_EVOLVE)}>
